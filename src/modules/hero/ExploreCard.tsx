...
const ExploreCard = ({
  ...
  >
    ...
    {active !== id ? (
      ...
      <div className="absolute bottom-0 p-8 flex justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px] maxMd:p-[8px]">
        {/* <div
        ...
        <h2 className="mt-[24px] font-semibold sm:text-[32px] text-[24px] text-white maxMd:mt-2">
          {title}
        </h2>
      </div>
    )}
